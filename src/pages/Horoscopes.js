...
const HOROSCOPES = [
  "Appreciating the comfort you've created for yourself could currently help you plan to get more of it. In particular, the New Moon in your 4th House of Security symbolizes a great time to pin down what feels most nourishing to you. Although your sign has a reputation for preferring logic over the softer sides of life, your powers of reason are surprisingly useful here. Think through what's working well to identify the underlying needs that must be met, and order your priorities accordingly.",
